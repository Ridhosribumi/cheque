...
app_description = "App for Cheque"
app_icon = "fa fa-clone"
app_color = "#FF4136"
...
# get_website_user_home_page = "cheque.utils.get_home_page"
...
doc_events = {
    "Payment Entry": {
        "on_submit": "cheque.reference.submit_cheque",
        "on_cancel": "cheque.reference.cancel_pe",
    },
    "Journal Entry": {
        "on_submit": "cheque.reference.submit_cheque_jv",
    }
}
